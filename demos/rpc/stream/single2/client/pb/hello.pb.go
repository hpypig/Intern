...
var file_pb_hello_proto_rawDesc = []byte{
	...
	0xae, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x31, 0x0a, 0x08, 0x53,
...
var file_pb_hello_proto_depIdxs = []int32{
	...
	1, // 3: pb.Greeter.SayHello:output_type -> pb.HelloResponse
	1, // 4: pb.Greeter.LotsOfReplies:output_type -> pb.HelloResponse
	1, // 5: pb.Greeter.LotsOfGreetings:output_type -> pb.HelloResponse
